...
class DataVisual:
    ...
    def draw_carNum(self):
        ...
        ax1.set_ylabel('km')
        ax1.plot(percent, total_dis1, label='only distance')
        ax1.plot(percent, total_dis2, label='storage and distance')
        ...
        ax2.set_ylabel('yuan')
        ax2.plot(percent, total_price1, label='only distance')
        ax2.plot(percent, total_price2, label='storage and distance')
        fig2.legend()
        plt.show()
